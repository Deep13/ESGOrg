sap.ui.define(
    ...
    function (Controller, JSONModel, Column, Label, Input, Select, Item, ColumnListItem, MessageToast, MessageBox) {
        "use strict";
        return Controller.extend("ESGOrg.ESGOrg.controller.Social.Employement", {
            /**
             * Called when a controller is instantiated and its View controls (if available) are already created.
             * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
             * @memberOf ESGOrg.ESGOrg.view.Employement
             */
            onInit: function () {
                this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
                this.oRouter
                    .getRoute("Employement")
                ...
                this.aColumns = [
                    {
                        ...
                        type: "dropdown",
                        dropdownValues: ["Employees", "Workers", "Temporary Employee"]
                    },
                    {
                        name: "Category",
                        type: "dropdown",
                        dropdownValues: ["Existing", "New Hires", "Kyoto protocol - standard", "Solid fuels"]
                    },
                    {
                        name: "Gender",
                        type: "dropdown",
            ...
            onpressBack: function (oEvent) {
                this.oRouter.navTo("SocialReporting");
            },
            onLogOut: function () {
                this.logOut();
            }
