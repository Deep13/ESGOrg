sap.ui.define([
    ...
    return Controller.extend("ESGOrg.ESGOrg.controller.Emissions.HomeOffice", {
        ...
        onAddRow: function () {
            ...
            var branch = this.getView().getModel("masterModel").getProperty("/branches");
            if (branch.length >= this.byId("flightTable").getItems().length) {
                ...
                MessageToast.show("You cannot add rows more than the branch offices you have.")
            }
        },
