sap.ui.define(
    ...
    function (Controller, JSONModel, Column, Label, Input, Select, Item, ColumnListItem, MessageToast, MessageBox) {
        "use strict";
        return Controller.extend("ESGOrg.ESGOrg.controller.Governance.Entity", {
            /**
             * Called when a controller is instantiated and its View controls (if available) are already created.
             * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
             * @memberOf ESGOrg.ESGOrg.view.Entity
             */
            onInit: function () {
                ...
                this.aColumns = [
                    {
                        name: "Entity Type",
                        type: "dropdown",
                        dropdownValues: ["BOD", "CFO/CEO", "Independent Directors", "Executives", "BOD turnover rate", "Compensation ratio"]
                    },
                    {
                        name: "Gender",
                        type: "dropdown",
                        dropdownValues: ["Male", "Female", "LGBTQ"]
                    },
                    {
                        name: "Age",
                        type: "dropdown",
                        dropdownValues: ["50+", "35 to 50", "22 to 35", "Less than 22", "Overall"]
                    },
                    {
                        name: "Tenure",
                        type: "dropdown",
                        dropdownValues: ["Less than 1 year", "Between 1- 2 years", "Between 2-5 years", "Between 5-7 years", "Between 7-9 years", "Above 10 years"]
                    },
                    {
                        name: "Count",
                        type: "text"
